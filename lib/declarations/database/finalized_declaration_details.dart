...
class FinalizedDeclarationDetails{
  ...
  DateTime?
      amendmentDate; //! We basically check which declarations have not been amended. Don't display a reservation that has been amandeded.
  final List<int> relatedDeclarationsSerialNumbers =
      []; //! We have a "history" button for the declaration. We can check our ammendments. - Only a finalized declaration can have a SerialNumber.
  ...
  bool isEqualTo(FinalizedDeclarationDetails finalizedDeclarationDetails) {
    return 
        finalizedDeclarationDetails.declarationDate == declarationDate &&
